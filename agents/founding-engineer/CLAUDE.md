...
0. **Load memory** — Read `agents/founding-engineer/memory/MEMORY.md` to recall persistent context, past decisions, and tacit knowledge from previous heartbeats. Update it when you learn something durable.
